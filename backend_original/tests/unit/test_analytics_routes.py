...
# tests that agency_id is required for analytics
...
# tests successful analytics response with mocked data
@patch('firebase_admin.firestore.client')
def test_get_analytics_success(mock_firestore, client):
    ...
    # create mock car and client documents
