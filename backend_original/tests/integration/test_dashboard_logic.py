...
def test_get_dashboard_stats_success(mock_firestore, client):
    ...
    # Define what each sequential call to .get() should return
    # 1st call: Ongoing (5), 2nd: Available (10), 3rd: Due Today (2)
    ...
    # Mock the activity query separately (different chain)
